          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  type="checkbox"
                  checked={showInDock}
                  onChange={(e) => updateTrayPreferences({ showInDock: e.target.checked })}
                  className="w-4 h-4"
                />
                <span className="text-sm">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) => updateTrayPreferences({ startMinimized: e.target.checked })}
                  className="w-4 h-4"
                />
                <span className="text-sm">
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                defaultValue="auto"
                onChange={(e) => updateTrayPreferences({ 
                  trayIconStyle: e.target.value as 'auto' | 'light' | 'dark' 
                })}
              >
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  type="checkbox"
                  defaultChecked={true}
                  onChange={(e) => updateTrayPreferences({ showNotifications: e.target.checked })}
                  className="w-4 h-4"
                />
                <span className="text-sm">
